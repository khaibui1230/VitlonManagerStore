...
namespace QuanVitLonManager.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(50, ErrorMessage = "Tên đăng nhập phải có từ {2} đến {1} ký tự.", MinimumLength = 3)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["SuccessMessage"] = "Đăng ký thành công! Vui lòng kiểm tra email của bạn để xác nhận tài khoản.";
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Không thể tạo instance của '{nameof(ApplicationUser)}'. " +
                    $"Đảm bảo rằng '{nameof(ApplicationUser)}' không phải là abstract class và có constructor không tham số.");
            }
        }
