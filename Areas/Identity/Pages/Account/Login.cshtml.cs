        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Add custom redirection logic based on user roles
                    ...
                    if (user != null)
                    {
                        ...
                        else if (roles.Contains("NhanVien"))
                        {
                            ...
                            return Redirect("/StaffOrder/Index");
                        }
                        else if (roles.Contains("Chef"))
                        {
                            _logger.LogInformation("Redirecting to Staff Chef");
                            return Redirect("/Staff/Chef/Index");
                        }
                    }
